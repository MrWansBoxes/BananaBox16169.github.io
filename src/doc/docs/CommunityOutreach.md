...
![Londonderry YMCA Photo](assets/img/YMCA.png){: style="display: block; margin: 0 auto;" width="600" }
...
![Plaistow Public Library Photo](assets/img/Plaistow.png){: style="display: block; margin: 0 auto;" width="600" }
...
![Thunder Over NH Air Show Photo](assets/img/Airshow.png){: style="display: block; margin: 0 auto;" width="600" }
...
![MIT Undergraduate Conference Photo](assets/img/MIT.png){: style="display: block; margin: 0 auto;" width="600" }
...
![Wicked Stem Festival Photo](assets/img/Wicked.png){: style="display: block; margin: 0 auto;" width="600" }
