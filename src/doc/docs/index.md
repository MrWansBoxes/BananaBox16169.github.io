...
![Team Photo](assets/img/BBoxTeamPhoto.png){: style="display: block; margin: 0 auto;" width="600" }
![Robot](assets/img/TeamRobot.png){: style="display: block; margin: 0 auto;" width="600" }
